...
import Scene5 from "../v5/Scene5";
import WatchingGod from "./WatchingGod";
import Reveal from "../v5/Reveal";
import MobileDelight from "../v5/MobileDelight";
    ...
    <div className={`oly ${marcellus.variable} ${cormorant.variable} ${manrope.variable}`}>
      ...
      <header className="oly-hero">
        ...
        <div className="oly-hero-inner">
          ...
          <Reveal delay={0.18}>
            <p className="oly-inscription" title="quality - test everything">
              &Pi;&Omicron;&Iota;&Omicron;&Tau;&Eta;&Sigma; &middot; &Delta;&Omicron;&Kappa;&Iota;&Mu;&Alpha;&Zeta;&Epsilon; &Pi;&Alpha;&Nu;&Tau;&Alpha;
            </p>
          </Reveal>
          <Reveal delay={0.22}>
      ...
      <section className="oly-section">
        <WatchingGod god="athena" side="right" tint="#a99ecf" />
        <Reveal>
      ...
      {/* ——— labors ——— */}
      <section className="oly-section">
        <WatchingGod god="hermes" side="left" tint="#d9a289" />
        <Reveal>
      ...
      {/* ——— decrees ——— */}
      <section className="oly-section">
        <WatchingGod god="apollo" side="right" tint="#9dba97" />
        <Reveal>
      ...
      <footer className="oly-contact">
        <Reveal>
          ...
          <p className="oly-colophon">
            ...
            pastels &amp; agents &middot; &psi;&upsilon;&chi;&#942; &mdash; the greek word for both soul and butterfly
          </p>
        </Reveal>
      </footer>
    </div>
